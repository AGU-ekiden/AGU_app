  ...
  return (
    <div className="bg-white border border-gray-100 rounded-xl p-3 shadow-sm">
      ...
      <div className="flex items-center gap-3 mb-2 px-0.5">
        ...
        <span className="flex items-center gap-1 text-[9px] text-gray-400">
          <span className="w-1.5 h-1.5 rounded-full bg-amber-600" />パーソナル
        </span>
        <span className="flex items-center gap-1 text-[9px] text-gray-400">
      ...
      <div className="grid grid-cols-7 mb-1">
        {DAY_NAMES.map((d, i) => (
          <div
            key={d}
            className={`text-center text-[10px] font-medium py-0.5 ${i === 0 ? "text-red-400" : i === 6 ? "text-amber-600" : "text-gray-400"}`}
          >
            {d}
          </div>
        ))}
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col gap-0.5 w-full">
                ...
                {hasPersonal && (
                  <span className="text-[6px] font-bold text-center px-0.5 rounded leading-tight w-full truncate bg-amber-100 text-amber-800">
                    パーソナル
                  </span>
                )}
                {hasRace && (
